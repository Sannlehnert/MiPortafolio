          ...
          fallback={
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[100]">
              <div className="bg-white dark:bg-[#1A261F] p-6 rounded-xl shadow-xl flex items-center gap-3">
                <div className="w-6 h-6 border-3 border-accent dark:border-[#31C48D] border-t-transparent rounded-full animate-spin" />
                <span className="text-text-primary dark:text-[#E5FAEF]">
                  Cargando proyectos...
                </span>
              </div>
            </div>
